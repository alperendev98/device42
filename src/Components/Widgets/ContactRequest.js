			...
			<div className="lazy-up">
				<div className="card pt-30">
					...
					<div className="card-foot d-flex align-self-end">
						<Button  size="small" onClick={() => this.onAccept()} className="btn-primary mr-5 mb-10 text-white"><IntlMessages id="button.accept" /></Button>
						<Button  size="small" onClick={() => this.onReject()} className="btn-warning mb-10 text-white"><IntlMessages id="button.reject" /></Button>
					</div>
				</div>
