        ...
        return (
            <Fragment>
                            ...
                            <ListItem className="border-bottom" button key={key} onClick={() => this.handleChange(!data.completed, data)}>
                                <div className={classnames('d-flex justify-content-between align-items-center w-100', { 'strike': data.completed })}>
                                    ...
                                    <div className="hover-action">
                                        <Button className="btn-danger text-white"  mini onClick={(e) => this.onDeleteTask(e, data)}><i className="zmdi zmdi-delete"></i></Button>
                                    </div>
                                </div>
                            </ListItem>
                        ))}
                ...
                <div className="d-flex p-3">
                    <Button  color="primary" className="text-white" onClick={() => this.opnAddNewTodoDialog()}><IntlMessages id="widgets.addNew" /></Button>
                </div>
                <Dialog
                    ...
                    <DialogActions>
                        ...
                        <Button  onClick={this.addNewTodo} color="primary" className="text-white">
