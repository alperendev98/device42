                           ...
                           <Collapse isOpen={collapse}>
                              <div className="d-flex p-4 form-wrap border-bottom justify-content-between">
                                 ...
                                 <div className="align-self-end d-flex flex-column text-center">
                                    <Button  color="primary" className="mb-30 text-white  btn-xs" onClick={() => this.addNewTask(project)}>
                                       <span><IntlMessages id="button.add" /></span>
                                    </Button>
                                    <Button  onClick={() => this.closeForm(project)} className="btn-xs btn-danger text-white">
