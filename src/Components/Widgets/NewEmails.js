    ...
    return (
      <Fragment>
              ...
              <li key={key}>
                ...
                <div className="d-flex justify-content-between">
                      ...
                      <div className="task-foot d-flex justify-content-between">
                        <InputGroup>
                          ...
                          <InputGroupAddon addonType="append">
                            <Button  color="primary" className="text-white" onClick={() => this.replyEmail(email)}>
                  ...
                  <div className="hover-action text-right w-25 align-self-center">
                    <Button color="primary" className="text-white mr-5 mb-5"  mini onClick={() => this.onViewEmal(email)}><i className="zmdi zmdi-eye"></i></Button>
                    <Button className="btn-danger text-white mr-5 mb-5"  mini onClick={() => this.onDeleteEmail(email)}><i className="zmdi zmdi-delete"></i></Button>
                    <Button className="btn-success text-white mr-5 mb-5"  mini onClick={() => this.showReplyTextBox(email)}><i className="zmdi zmdi-mail-reply"></i></Button>
                  </div>
                </div>
              </li>
            ))}
        ...
        >
          ...
          <DialogActions>
            <Button  className="btn-danger text-white" onClick={this.handleCloseConfirmationAlert}>
              <IntlMessages id="button.cancel" />
            </Button>
            <Button  color="primary" className="text-white" onClick={() => this.deleteEmail()}>
