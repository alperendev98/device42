		...
		return (
			<Fragment>
						...
						{newCustomers && newCustomers.map((customer, key) => (
							<li className="list-group-item d-flex justify-content-between" key={key}>
								...
								<div className="d-flex align-items-end">
									<div  color="primary" onClick={() => this.onEditCustomer(customer)}>
										<i className="zmdi zmdi-edit"></i>
									</div>
									<div  className="text-danger" onClick={() => this.onDeleteCustomer(customer)}>
				...
				<div className="d-flex p-3">
					<Button  color="primary" className="text-white" onClick={() => this.addNewCustomer()}><IntlMessages id="widgets.addNew" /></Button>
				</div>
				...
				{editCustomerModal &&
					...
					>
						...
						<ModalFooter>
							{addNewCustomerForm ?
								<div>
									<Button  color="primary" className="text-white" onClick={() => this.onSubmitAddNewCustomerForm()}><IntlMessages id="button.add" /></Button>{' '}
									<Button  className="btn-danger text-white" onClick={this.toggleEditCustomerModal}><IntlMessages id="button.cancel" /></Button>
								</div>
								: <div><Button  color="primary" className="text-white" onClick={() => this.onSubmitCustomerEditDetailForm()}><IntlMessages id="button.update" /></Button>{' '}
									<Button  className="btn-danger text-white" onClick={this.toggleEditCustomerModal}><IntlMessages id="button.cancel" /></Button></div>
							}
						</ModalFooter>
					</Modal>
				}
